...
const menuItems: MenuItem[] = [
  { id: 'dashboard', title: 'داشبورد', icon: 'dashboard', path: '/dashboard' },
  { id: 'items', title: 'آیتم‌ها', icon: 'items', path: '/items' },
  { id: 'categories', title: 'دسته‌بندی‌ها', icon: 'categories', path: '/categories' },
  { id: 'reports', title: 'گزارش‌ها', icon: 'reports', path: '/reports' },
  { id: 'places', title: 'محل‌های من', icon: 'location', path: '/' },
  { id: 'purchases', title: 'خریدها', icon: 'buy', path: '/purchases' },
  { id: 'deposits', title: 'امانات', icon: 'deposits', path: '/deposits' },
  { id: 'profile', title: 'پروفایل', icon: 'profile', path: '/profile' },
  { id: 'exit', title: 'خروج', icon: 'exit', path: '/logout' },
];
